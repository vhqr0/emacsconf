...
(defvar termbright-error      termbright-red3)
(defvar termbright-warning    termbright-yellow3)
(defvar termbright-success    termbright-green3)
...
(custom-theme-set-faces
 ...
 `(font-lock-warning-face              ,termbright-error)
 ...
 `(font-lock-function-name-face        ,termbright-light1)
 `(font-lock-variable-name-face        ,termbright-light1)
 `(font-lock-property-name-face        ,termbright-light0)
