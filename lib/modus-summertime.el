(defvar modus-summertime-operandi
  '((bg-main . "#fff0f2")
    (bg-dim . "#fbe6ef")
    (bg-alt . "#f5dae6")
    (bg-hl-line . "#fad8e3")
...
(defvar modus-summertime-vivendi
  '((bg-main . "#25152a")
    (bg-dim . "#2a1930")
    (bg-alt . "#382443")
    (bg-hl-line . "#332650")
...
(define-minor-mode modus-summertime-mode
  "Toggle modus overrides."
  :init-value nil
  :global t
  (if modus-summertime-mode
      ;; Override the given associations when the minor mode is enabled
      (setq modus-themes-operandi-color-overrides
            modus-summertime-operandi
            modus-themes-vivendi-color-overrides
            modus-summertime-vivendi)
    ;; Remove the overrides if the minor mode is disabled
    (setq modus-themes-operandi-color-overrides nil
          modus-themes-vivendi-color-overrides nil)))

;;;###autoload
(defun modus-summertime-toggle ()
  (interactive)
  (call-interactively 'modus-summertime-mode)
